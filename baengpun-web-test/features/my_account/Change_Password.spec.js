...
test.describe('New registration and change password', () => {

    const new_password = 'newPass_' + (new Date()).getTime();
    ...
    test('Register', async ({ page }) => {
        ...
        await page1.getByRole('link', { name: 'บัญชีของฉัน', exact: true }).click();
