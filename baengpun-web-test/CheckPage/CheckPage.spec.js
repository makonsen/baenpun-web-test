...
test.describe('Check Page', () => {
    test('Home page from the navbarCollapse', async ({ page }) => { // แถบนำทาง
        await page.goto(serverUrl);
        await page.getByRole('link', { name: 'หน้าแรก' }).click();
        await expect(page).toHaveTitle('แบ่งปั๋น');
    });

    test.describe('navbarCollapse => My Account', () => { // แถบนำทาง
    ...
    test.describe('navbarCollapse => About us', () => { // แถบนำทาง
    ...
    test('booklet from the navbarCollapse', async ({ page }) => { // แถบนำทาง
        await page.goto(serverUrl);
